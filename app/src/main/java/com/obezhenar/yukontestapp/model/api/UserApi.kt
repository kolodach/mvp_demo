...
/**
 * This class defines API methods specific for the User object
 */
interface UserApi {
    /**
     * Log in using Basic Auth
     */
    fun basicAuth(email: String, password: String): Observable<AuthResponse>

    fun refreshToken(refreshToken: String): Observable<AuthResponse>

    fun registration(user: User): Observable<AuthResponse>
}
